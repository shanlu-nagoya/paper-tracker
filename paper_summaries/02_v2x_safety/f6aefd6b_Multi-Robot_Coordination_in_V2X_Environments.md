...
## Metadata
- **Authors**: J. Arockiasamy, Alexey Vinel
- **Year**: 2026
- **Venue**: 
- **Topic**: V2X Safety
- **Keyword matched**: `V2X safety communication`
- **Semantic Scholar**: https://www.semanticscholar.org/paper/f6aefd6bbfacb159cb1a3ee46219b7683a199f4c
- **arXiv**: https://arxiv.org/abs/2605.06662
- **DOI**: N/A
