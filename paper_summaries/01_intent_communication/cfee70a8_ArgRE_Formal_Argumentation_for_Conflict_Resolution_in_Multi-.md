...
## Metadata
- **Authors**: Haowei Cheng, Milhan Kim, Chong Liu, Teeradaj Racharak, T. V. Duy et al. (+4)
- **Year**: 2026
- **Venue**: 
- **Topic**: Intent-Aware Communication
- **Keyword matched**: `semantic communication goal-oriented`
- **Semantic Scholar**: https://www.semanticscholar.org/paper/cfee70a8beead96f8f60ed7b105561430524803a
- **arXiv**: https://arxiv.org/abs/2604.23124
- **DOI**: N/A
